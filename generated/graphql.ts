...
export type GetBooksQuery = { __typename?: 'Query', books?: Array<{ __typename?: 'Book', id: number, title: string, author: string, coverImageUrl: string, publisher: string, synopsis: string, pageCount: number } | null> | null };
